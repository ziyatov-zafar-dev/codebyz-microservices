...
public class ResponseDto<T> {
    ...
    public static <T> ResponseDto<T> ok(String message, int code, ErrorCode errorCode, T data) {
        return new ResponseDto<T>(true, message, code, errorCode, data);
    }

    public static <T> ResponseDto<T> fail(int code, ErrorCode errorCode, String message) {
        return new ResponseDto<T>(false, message, code, errorCode, null);
    }

    public static <T> ResponseDto<T> fail(int code, ErrorCode errorCode, String message, T data) {
        return new ResponseDto<T>(false, message, code, errorCode, data);
    }
