...
// O'quvchining modul bo'yicha progressini kuzatish
@Entity
@Table(
        name = "module_progress",
        uniqueConstraints = @UniqueConstraint(name = "uk_module_progress_module_student", columnNames = {"module_id", "student_id"})
)
public class ModuleProgress {
    ...
    private CourseModule module; // Maqsad modul
